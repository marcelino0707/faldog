export const services = [
    ...
    },
    {
        ...
        title: "Pekerjaan Penyiapan dan Pematangan Tanah",
        ...
        second_content: "Penyiapan dan pematangan tanah adalah serangkaian kegiatan untuk mempersiapkan tanah di lokasi proyek agar memiliki daya dukung yang cukup bagi struktur yang akan dibangun di atasnya. Penyiapan tanah melibatkan pembersihan lahan, penggalian, dan pengurugan, sementara pematangan tanah mencakup pemadatan, stabilisasi, dan pengelolaan drainase. Kedua proses ini bertujuan untuk memastikan permukaan tanah memiliki kekuatan dan stabilitas yang diperlukan, sehingga konstruksi dapat berjalan dengan aman dan lancar."
    },
    {
        slug: "7",
        ...
        second_content: "Sebagai penyedia material konstruksi yang berpengalaman, kami memahami betapa pentingnya kualitas dan ketepatan waktu dalam setiap proyek. Dengan komitmen pada mutu, ketersediaan material yang lengkap, dan dukungan logistik yang kuat, kami siap menjadi mitra Anda dalam menyukseskan proyek konstruksi, mulai dari tahap awal hingga penyelesaian akhir."
    },
    {
        slug: "8",
        ...
        second_content: "Jasa Heavy Duty Rental adalah layanan penyewaan alat berat yang digunakan dalam proyek konstruksi, penggalian, pengangkutan material, pemadatan tanah, hingga pemeliharaan infrastruktur. Dengan layanan ini, perusahaan konstruksi atau kontraktor tidak perlu membeli alat berat sendiri, sehingga dapat menghemat biaya operasional dan perawatan. Kami menyediakan berbagai jenis alat berat yang sesuai dengan kebutuhan proyek, mulai dari excavator, bulldozer, crane, hingga roller pemadat."
    }
];
